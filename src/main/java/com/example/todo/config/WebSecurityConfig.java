...
public class WebSecurityConfig {
   ...
   public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
      ...
      http
            ...
            // 새션 관리 상태를 STATELESS로 설정해서 spring security가 제공하는 새션 생성 및 관리 기능 사용하지 않겠다.
            ...
            .authorizeHttpRequests(authorizeRequests ->
                  authorizeRequests
                        // '/api/todos' 라는 요청이 post로 들어오고, Role 값이 ADMIN인 경우 권한 검사 없이 허용하겟다.
                        ...
                        .permitAll()
                        // 위에서 따로 설정=하지 않은 나머지 요청들은 권한 검사가 필요하다.
